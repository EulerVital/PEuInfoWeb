...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <form runat="server">
        <div class="row panel" style="background-color:#FFF;">
            <div class="container col-md-offset-2">
                <div class="col-md-2 form-group btn btn-primary">
                    ...
                    <div class="form-group">  
                       <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#divCsharp">Obter Conhecimento</button>                       
                    </div>
                </div>
          ...
          <asp:Panel id="divCsharp" class="collapse" runat="server" BackColor="White">
              <div class="panel-heading">
                  <h2 class="panel-title">CSharp com .NET Microsoft</h2>
              </div>
         </asp:Panel>
         <asp:Panel id="divPython" class="collapse" runat="server" BackColor="White">
              <div class="panel-heading">
                  <h2 class="panel-title">Python uma linguagem facil é util, ela te espera.</h2>
              </div>
         </asp:Panel>
         <asp:Panel id="divC" class="collapse" runat="server" BackColor="White">
              <div class="panel-heading">
                  <h2 class="panel-title">C venha conhecer uma das linguagesn mais antiga e atuais até o momento.</h2>
              </div>
         </asp:Panel>
         <asp:Panel id="divPhp" class="collapse" runat="server" BackColor="White">
              <div class="panel-heading">
